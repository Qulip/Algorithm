...
class Main{
    ...
    static String BFS(int A, int B){
        ...
        while(!que.isEmpty()){
            ...
            sb = new StringBuilder(now.str);        //2배
            sb.append('D');
            ...
            sb = new StringBuilder(now.str);        //n-1
            sb.append('S');
            ...
            sb = new StringBuilder(now.str);        //좌측 이동
            sb.append('L');
            ...
            sb = new StringBuilder(now.str);        //우측 이동
            sb.append('R');
